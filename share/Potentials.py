...
d1_dense=pd.read_csv('./data/Potentials/Potential_Chi2mom_a3tuned_meff.dat',delimiter='\t',comment="#")
print(d1_dense.head)
d2_dense=pd.read_csv('./data/Potentials/Potential_Chi3mom_a3tuned_meff.dat',delimiter='\t',comment="#")
d3_dense=pd.read_csv('./data/Potentials/Potential_LY4_a3tuned_meff.dat',delimiter='\t',comment="#")
