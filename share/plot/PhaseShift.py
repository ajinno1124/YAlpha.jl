...
d1=pd.read_csv('../data/PhaseShift/PhaseShift_Chi2mom_a3tuned_meff.dat',delimiter='\t',comment="#")
print(d1.head)
d2=pd.read_csv('../data/PhaseShift/PhaseShift_Chi3mom_a3tuned_meff.dat',delimiter='\t',comment="#")
d3=pd.read_csv('../data/PhaseShift/PhaseShift_LY4_a3tuned_meff.dat',delimiter='\t',comment="#")
